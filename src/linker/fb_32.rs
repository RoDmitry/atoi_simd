...
impl ParsePos for u8 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<u8, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ u8::MAX as u64 }>(s).map(|v| v as u8)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(u8, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i8 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<i8, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ i8::MAX as u64 }>(s).map(|v| v as i8)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(i8, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i8 {
    #[inline(always)]
    fn atoi_simd_parse_neg(s: &[u8]) -> Result<i8, AtoiSimdError<'_>> {
        parse_fb_checked_neg::<{ i8::MIN as i64 }>(s).map(|v| v as i8)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_neg(s: &[u8]) -> Result<(i8, usize), AtoiSimdError<'_>> {
...
impl ParsePos for u16 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<u16, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ u16::MAX as u64 }>(s).map(|v| v as u16)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(u16, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i16 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<i16, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ i16::MAX as u64 }>(s).map(|v| v as i16)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(i16, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i16 {
    #[inline(always)]
    fn atoi_simd_parse_neg(s: &[u8]) -> Result<i16, AtoiSimdError<'_>> {
        parse_fb_checked_neg::<{ i16::MIN as i64 }>(s).map(|v| v as i16)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_neg(s: &[u8]) -> Result<(i16, usize), AtoiSimdError<'_>> {
...
impl ParsePos for u32 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<u32, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ u32::MAX as u64 }>(s).map(|v| v as u32)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(u32, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i32 {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<i32, AtoiSimdError<'_>> {
        parse_fb_checked_pos::<{ i32::MAX as u64 }>(s).map(|v| v as i32)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_pos(s: &[u8]) -> Result<(i32, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i32 {
    #[inline(always)]
    fn atoi_simd_parse_neg(s: &[u8]) -> Result<i32, AtoiSimdError<'_>> {
        parse_fb_checked_neg::<{ i32::MIN as i64 }>(s).map(|v| v as i32)
    }

    #[inline(always)]
    fn atoi_simd_parse_prefix_neg(s: &[u8]) -> Result<(i32, usize), AtoiSimdError<'_>> {
...
impl ParsePos for usize {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<usize, AtoiSimdError<'_>> {
...
impl ParsePos for isize {
    #[inline(always)]
    fn atoi_simd_parse_pos(s: &[u8]) -> Result<isize, AtoiSimdError<'_>> {
...
impl ParseNeg for isize {
    #[inline(always)]
    fn atoi_simd_parse_neg(s: &[u8]) -> Result<isize, AtoiSimdError<'_>> {
