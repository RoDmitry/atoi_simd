...
fn bench_32(bench_group: &mut BenchmarkGroup<WallTime>, str: &str) {
    ...
    bench_group.bench_with_input(
        ...
        |b, val| {
            b.iter(|| {
                parse_skipped::<u32>(val[0].as_bytes()).unwrap()
                    - parse_skipped::<u32>(val[1].as_bytes()).unwrap()
            })
        },
    );
...
fn bench_64(bench_group: &mut BenchmarkGroup<WallTime>, str: &str) {
    ...
    bench_group.bench_with_input(
        ...
        |b, val| {
            b.iter(|| {
                parse_skipped::<u64>(val[0].as_bytes()).unwrap()
                    - parse_skipped::<u64>(val[1].as_bytes()).unwrap()
            })
        },
    );
    /* bench_group.bench_with_input(
...
fn bench_128(bench_group: &mut BenchmarkGroup<WallTime>, str: &str) {
    ...
    bench_group.bench_with_input(
        ...
        |b, val| {
            b.iter(|| {
                parse_skipped::<u128>(val[0].as_bytes()).unwrap()
                    - parse_skipped::<u128>(val[1].as_bytes()).unwrap()
            })
        },
    );
