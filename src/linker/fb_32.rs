...
impl ParsePos for u8 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(u8, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i8 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(i8, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i8 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_neg(s: &[u8]) -> Result<(i8, usize), AtoiSimdError<'_>> {
...
impl ParsePos for u16 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(u16, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i16 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(i16, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i16 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_neg(s: &[u8]) -> Result<(i16, usize), AtoiSimdError<'_>> {
...
impl ParsePos for u32 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(u32, usize), AtoiSimdError<'_>> {
...
impl ParsePos for i32 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_pos(s: &[u8]) -> Result<(i32, usize), AtoiSimdError<'_>> {
...
impl ParseNeg for i32 {
    ...
    #[inline(always)]
    fn atoi_simd_parse_any_neg(s: &[u8]) -> Result<(i32, usize), AtoiSimdError<'_>> {
